...
export function LanguageToolPopover({ match, anchorPos, onAccept, onDismiss }) {
  ...
  return (
    ...
    >
      <div className="lt-popover-header">
        ...
        <button className="lt-popover-close" onClick={onDismiss} aria-label="Dismiss">✕</button>
      </div>
